export const environment = {
  production: false,
  apiTrainers: "https://new-cool-quiz.herokuapp.com/trainers",
  apiKey: "54321",
  apiPokemon: "https://pokeapi.co/api/v2/pokemon/", // + id OR name -> single pokemon info, + offset & limit -> list of pokemon w names and link to info
